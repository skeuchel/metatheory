...
Proof.
  ...
  - destruct IHwt1 as [v1|[c1 [s1 [s1' [r1 eq_t1]]]]]; subst.
    + destruct IHwt2 as [v2|[c2 [s2 [s2' [r2 eq_t2]]]]]; subst.
      * destruct (can_form_tarr v1 wt1) as [T11' [t12 eq_t2]]; subst.
  ...
  - destruct IHwt as [v1|[c1 [s1 [s1' [r1 eq_t1]]]]]; subst.
    + destruct (can_form_tall v1 wt) as [T1' [t11 eq1]]; subst.
      exists c_hole, (tapp (tabs T1' t11) T2), (tsubstTm X0 T2 t11).
